...
- (void)tableViewSelectionDidChange:(NSNotification *)notification
{
  ...
  if(tableDelegate && [tableDelegate respondsToSelector:@selector(runSelectionChange:)])
    [tableDelegate runSelectionChange:tableSelectedRow];
}
