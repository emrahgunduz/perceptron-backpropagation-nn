...
@implementation emrTrainViewInputTable

@synthesize tableDelegate;
@synthesize tableData;
@synthesize tableSelectedRow;
...
- (void)tableViewSelectionDidChange:(NSNotification *)notification
{
  ...
  if(tableDelegate && [tableDelegate respondsToSelector:@selector(selectionChange:)])
    [tableDelegate selectionChange:tableSelectedRow];
}
